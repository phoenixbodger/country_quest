...
function CapitalQuestStats({ stats, config, mode, onReplaySame, onChangeSettings, onHome, onCountryClick }) {
  ...
  const modeLabel = mode === 'capital' ? '🏙️ Name the Capital' : '🌍 Name the Country';
...
export default CapitalQuestStats;
