...
function CoordinatesQuestSetup({ onStart, initialMode }) {
  ...
  return (
    <div style={{ maxWidth: '520px', margin: '10px auto', background: '#1a202c', border: '1px solid #2d3748', borderRadius: '12px', padding: '18px' }}>
      <div style={{ fontSize: '18px', fontWeight: 'bold', color: 'white', marginBottom: '6px' }}>Setup Coordinates Quest</div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', textAlign: 'left' }}>
        <div>
          <div style={labelStyle}>Number of rounds</div>
...
export default CoordinatesQuestSetup;